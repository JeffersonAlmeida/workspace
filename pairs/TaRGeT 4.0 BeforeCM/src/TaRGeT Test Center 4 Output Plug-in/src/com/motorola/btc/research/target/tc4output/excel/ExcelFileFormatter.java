 ...
 * fsf2      Feb 17, 2008       -        Changed the xls write.
 */
...
public class ExcelFileFormatter extends OutputDocumentExtension{
	...
	protected void mountTestCaseInfo(int tcCount, TextualTestCase testCase)
	{
		...
		// Case number
		this.createCell(row, 1, testCase.getTcID(), this.textAreaStyle);
		...
		// Description/Name
		this.createCell(row, 5, testCase.getStrId(), this.textAreaStyle);
