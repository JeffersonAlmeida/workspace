...
public class TestCaseGeneratorController
{
	...
	public File writeTestSuiteFile(TestSuite<TextualTestCase> testSuite) throws IOException
	{
		...
		if(this.outputDocumentExtension == null)
		{
			...
			{
				this.outputDocumentExtension = outputDocumentData
		...
		if(this.outputDocumentExtension != null)
		{
			this.outputDocumentExtension.setTestCases(testSuite.getTestCases());
			this.outputDocumentExtension.writeTestCaseDataInFile(result);
		}
