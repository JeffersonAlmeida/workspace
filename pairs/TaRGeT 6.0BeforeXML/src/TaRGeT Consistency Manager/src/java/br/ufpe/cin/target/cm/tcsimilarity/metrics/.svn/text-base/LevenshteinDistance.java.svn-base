...
public final class LevenshteinDistance
{
     ...
     * objects. It there is any (upper or lower) case difference, an extra .5 is added to the
     * distance. This slightly penalizes for case differences, rather than giving a severe
     * penalty when each character case difference is counted as a full transformation.
     * <p>
