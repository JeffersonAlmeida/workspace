...
import com.motorola.btc.research.target.cm.CMActivator;
...
public class OldTestSuitesPage extends WizardPage
{
    ...
    {
        super("");
        this.setTitle("Available Test Suites");
        this.setDescription("Select a test suite to compare.");
