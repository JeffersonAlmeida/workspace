 ...
 */
public class OldTestSuitesSelectionPage extends WizardPage
{
    /**
     ...
     */
    protected OldTestSuitesSelectionPage(File oldTestSuiteDir)
    {
        super("");
    ...
    private class TestSuitesLabelProvider extends LabelProvider implements ITableLabelProvider
    {
        ...
        {
#if($xmloutput)
            return CMActivator.imageDescriptorFromPlugin(CMActivator.PLUGIN_ID, "icons/xml_icon_16_16.bmp").createImage();
#elseif($html)
            return CMActivator.imageDescriptorFromPlugin(CMActivator.PLUGIN_ID, "icons/html_icon_16_16.bmp").createImage();
#else
            return CMActivator.imageDescriptorFromPlugin(CMActivator.PLUGIN_ID, "icons/excel_icon_16_16.bmp").createImage();
#end
        }
