 ...
 */
package br.ufpe.cin.target.cnl.generatetestsuite.wizards;
...
import br.ufpe.cin.target.tcg.progressbars.GenerateTestCaseProgress;
import br.ufpe.cin.target.tcg.wizards.TabFolderPage;
...
public class NewTCGWizard extends Wizard
{
    ...
    /**
     * @see br.ufpe.cin.target.tcg.progressbars.GenerateTestCaseProgress#getGenerationTime()
     */
    ...
    /**
     * @see br.ufpe.cin.target.tcg.progressbars.GenerateTestCaseProgress#getNumberOfGeneratedTestCases()
     */
    ...
    /**
	 * @return the generated test suite file
	 */
	public File getTestSuiteFile() {
		return progress.getTestSuiteFile();
	}
}
