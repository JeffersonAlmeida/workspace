 ...
 */
package br.ufpe.cin.target.xlsinput.controller;

import java.io.File;
import java.io.FileFilter;

import br.ufpe.cin.target.xlsinput.extractor.UseCaseDocumentExtractor;
import br.ufpe.cin.target.xlsinput.filefilter.XLSFileFilter;
 ...
 */
public class XLSDocumentExtensionImplementation extends InputDocumentExtension 
{
    ...
    {
    	UseCaseDocumentExtractor phonebookExtractor = new UseCaseDocumentExtractor(file);
    	
    	UseCaseDocument useCaseDocument = phonebookExtractor.buildUseCaseDocument();
