...
public class TextualTestCase extends TestCase<TextualStep>
{
     ...
     */
    public TextualTestCase(int id, List<TextualStep> steps, String executionType,
            String regressionLevel, String strId, String objective, String requirements,
            String setups, String initialConditions, String note, String finalConditions,
            String cleanup, String useCaseReferences)
    {
        super(id, steps);
        this.executionType = executionType;
        this.regressionLevel = regressionLevel;
        this.description = strId;
