...
import com.motorola.btc.research.target.tcg.excel.ExcelFileFormatter;
...
public class TestCaseGeneratorController
{
    ...
    {
        ExcelFileFormatter formater = new ExcelFileFormatter(testSuite.getTestCases());
        ...
        formater.writeTestCaseDataInFile(result);
        return result;
    }
