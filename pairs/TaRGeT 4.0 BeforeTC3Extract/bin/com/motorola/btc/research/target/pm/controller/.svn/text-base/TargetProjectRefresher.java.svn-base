...
public class TargetProjectRefresher
{
            ...
            int operation) throws TargetException
    {
        ...
        try
        {
            folderDocs = FileUtil.getPhoneDocumentFiles(this.currentProject.getUseCaseDir());
        }
        catch (IOException e)
        {
            e.printStackTrace();
            ...
            throws TargetException
    {
        ...
        Collection<PhoneDocument> justLoadedDocuments = wordProcessing
                .createObjectsFromWordDocument(new ArrayList<String>(docsToBeLoaded),
