...
public class WordDocumentProcessing
{
     ...
     * process.
     * 
     * @throws UseCaseDocumentXMLException In case of any error during the signal sending.
     */
     ...
     * @throws UseCaseDocumentXMLException In case of any error accessing the .NET standard input and output.
     */
            ...
            throws UseCaseDocumentXMLException
    {
        ...
        catch (IOException e)
        {
            ...
            throw new UseCaseDocumentXMLException(e,
                    "Error connecting to .NET program. The XML extraction result could not be read.");
        }
        return result;
    }

    /**
     * Reads and analyzes the responses to the stimuli passed to .NET program.
     * 
     ...
     * 
     * @throws UseCaseDocumentXMLException In case of error on the .NET program execution.
     */
     ...
     * of the list <code>docfileNames</code>. The XML content of each Word document is stored in
     ...
     * @throws UseCaseDocumentXMLException It is launched in case of any error during the extraction
     * process.
     */
