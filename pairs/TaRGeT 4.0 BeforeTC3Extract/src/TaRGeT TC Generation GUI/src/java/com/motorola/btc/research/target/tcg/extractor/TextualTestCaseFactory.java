...
public class TextualTestCaseFactory
{
            ...
            List<Flow> documentsFlows)
    {
        ...
        String strId = createTCId(rawTest);
        ...
        TextualTestCase textualTest = new TextualTestCase(rawTest.getId(), steps, executionType,
                regLevel, strId, objective, strRequirements, setups, initialConditions, note,
                finalConditions, cleanup, strUseCases);
        return textualTest;
    }
    ...
    private  String createTCId(TestCase<FlowStep> rawTest)
    {
        ...
        result = result + checkPrintUseCaseDescriptionProperty(rawTest);
