 ...
 * fsf2     Jun 29, 2009                 Added refresh interface.
 * lmn3     Oct 08, 2009                 Changed name of the class form UseCaseEditor to UseCaseViewer.
 * fsf2     Jan 25, 2010                 Fixed bug in the exclusion of use case documents.
 */
 ...
 * uses cases contained in use case documents. It uses a SWT browser to display the
 ...
 */
public class UseCaseViewer extends EditorPart implements RefreshableEditor
{

    /**
     * The ID of the editor that is declared in plugin.xml.
     */
    public static final String ID = "br.ufpe.cin.target.pm.editors.UseCaseViewer";
     ...
     * in their xml declarations have the enables for attribute set to '+' which means that it
     * begins disabled and when any selection is activated their status is changed.
     */
        ...
        if (input instanceof PathEditorInput)
        {
            ...
            if (newUseCase != null)
            {
                ...
                try
                {
                    ...
                    this.file = generator.createHTMLFromUseCase(newUseCase, newFeature, newErrors);
