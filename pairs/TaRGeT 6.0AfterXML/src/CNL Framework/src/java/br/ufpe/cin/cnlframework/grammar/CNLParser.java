...
public class CNLParser {
	...
	private List<String> parentNodeNames;

	//TODO changed
	private List<ParsingPossibility> parsingPossibilities;
	
	//INSPECT Lais - new attribute
	private  List<ParserTreeNode> errorTrees;
	 ...
	 */
	//INSPECT - Lais new parameter List<String> parentNodeNames
	public List<ParserTreeNode> parseTaggedSentence(
			TaggedSentence taggedSentence, GrammarNode grammar, List<String> parentNodeNames) {
		...
		this.errorTrees = new ArrayList<ParserTreeNode>();
	...
	private List<ParserTreeNode> parseTaggedSentence(
		...
		if (pos < taggedSentence.getSize()) {
			...
			if (subGrammar instanceof NonTerminalGrammarNode) {
			    if (parentNodeNames.contains(subGrammar.getName())) {
    ...
    /**
     * Gets the errorTrees value.
     *
     * @return Returns the errorTrees.
     */
    public List<ParserTreeNode> getErrorTrees()
    {
        return errorTrees;
    }

    /**
     * Sets the errorTrees value.
     *
     * @param errorTrees The errorTrees to set.
     */
    public void setErrorTrees(List<ParserTreeNode> errorTrees)
    {
        this.errorTrees = errorTrees;
    }
}
