...
public class DuplicatedFeatureIdBetweenDocumentsError implements Error
{
    ...
    /**
     * Build the error. It receives the name of the documents with duplicated ID error and the
     * feature that has the duplicated ID.
     * 
     * @param document1Name One of the documents with duplicated feature ID.
     * @param document2Name The other document.
     * @param feature The feature with duplicated ID. This feature belongs to the document specified
     * by the attribute <code>document1Name</code>.
     */
    public DuplicatedFeatureIdBetweenDocumentsError(String document1Name, String document2Name,
            Feature feature)
    {
