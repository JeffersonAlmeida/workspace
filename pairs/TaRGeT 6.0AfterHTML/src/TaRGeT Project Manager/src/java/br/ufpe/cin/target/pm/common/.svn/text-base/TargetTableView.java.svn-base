...
public abstract class TargetTableView extends TargetView
{
    ...
    /**
     * Adds the resizing capablity to the table so that its columns can be automatically resized.
    ...
    private void addResizeCapability(final TableColumn[] columns)
    {
        ...
        group.addControlListener(new ControlAdapter()
        {
            public void controlResized(ControlEvent e)
            {
                ...
                /* verifies if the preferredSize height is greater than the avalible height */
