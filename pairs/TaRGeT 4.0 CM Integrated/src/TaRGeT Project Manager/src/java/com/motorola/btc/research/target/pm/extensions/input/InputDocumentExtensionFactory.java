...
public class InputDocumentExtensionFactory
{
     ...
     * <code>com.motorola.btc.research.target.mswordinput.controller.MSWordDocumentExtensionImplementation</code>.
     */
                        ...
                        try
                        {
                            ...
                            ImageDescriptor documentIconDescriptor = AbstractUIPlugin
                                    .imageDescriptorFromPlugin(
                                            extension.getContributor().getName(), documentIcon);
                            ...
                            ImageDescriptor documentErrorIconDescriptor = AbstractUIPlugin
                                    .imageDescriptorFromPlugin(
                                            extension.getContributor().getName(), documentErrorIcon);
