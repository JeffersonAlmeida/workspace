...
public class TestPurposeCreationPage extends WizardPage implements TCGPage
{
    ...
    {
        super("");
        setTitle(Properties.getProperty("test_suite_generation_by_purpose"));
        setDescription(Properties.getProperty("create_the_test_purposes"));
    ...
    {
        Composite leftContainer = this.createBasicGroup(parent, Properties.getProperty("current_test_purpose"), 1);
        ...
        Button moveUpButton = this.createButton(rightContainer, Properties.getProperty("up"), 40, 25);
        Button selectCurrentPurpose = this.createButton(rightContainer, "OK");
        Button moveDownButton = this.createButton(rightContainer, Properties.getProperty("down"), 40, 25);
        Button discardCurrentPurpose = this.createButton(rightContainer, Properties.getProperty("clean"));
    ...
    {
        Composite leftContainer = this.createBasicGroup(parent, Properties.getProperty("steps"), 1);
        ...
        gd.grabExcessVerticalSpace = true;
        rightContainer.setLayoutData(gd);
        Button selectStepsButton = this.createButton(rightContainer, Properties.getProperty("select"));
    ...
    {
        Composite leftContainer = this.createBasicGroup(parent, Properties.getProperty("created_test_purposes"), 1);
        ...
        gd.grabExcessVerticalSpace = true;
        rightContainer.setLayoutData(gd);
        Button cleanSelectedEntry = this.createButton(rightContainer, Properties.getProperty("clean"));
        Button cleanAllEntries = this.createButton(rightContainer, Properties.getProperty("clean_all"));
    ...
    {
        return this.createButton(parent, label, 65, 25);
    }
    ...
    private void createSliderBar(Composite parent)
    {
        ...
        String similarityStr = Properties.getProperty("path_coverage");
