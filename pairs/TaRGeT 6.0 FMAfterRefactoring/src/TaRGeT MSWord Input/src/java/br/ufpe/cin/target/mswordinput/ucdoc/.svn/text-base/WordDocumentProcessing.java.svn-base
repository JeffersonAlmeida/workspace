 ...
 */
package br.ufpe.cin.target.mswordinput.ucdoc;
...
/**
 * This class is used to extract a <code>UseCaseDocument</code> Java object from a Word Document.
 * 
 * <pre>
 * CLASS:
 ...
 * The second step consists in reading the extracted XML file, parsing it, and mounting the <code>UseCaseDocument</code> Java object.   
 *  
 * USAGE:
 * WordDocumentProcessing wdp = WordDocumentProcessing();
 * UseCaseDocument pDoc = wdp.createObjectsFromWordDocument(<word_document_file_path>);
 */
public class WordDocumentProcessing
{
     ...
     * of <code>UseCaseDocument</code> objects. During this process, a XML file is written and
     ...
     * extraction error.
     * @return A list of <code>UseCaseDocument</code> objects.
     * @throws UseCaseDocumentException It may be thrown during the XML extraction from Word
     * document, or during the XML parsing.
     */
    public synchronized List<UseCaseDocument> createObjectsFromWordDocument(
            List<String> docFileNames, boolean throwExceptionOnAnyError)
            throws UseCaseDocumentXMLException
    {
        List<UseCaseDocument> result = new ArrayList<UseCaseDocument>();
