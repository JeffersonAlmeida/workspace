...
public class AddStepBellowAction extends AbstractTCGAction{
	...
	public AddStepBellowAction(TableViewer tv, ScrolledForm sf, String id, String text, String tooltipText,
	...
	public void run(ISelection selection)
    {
        ...
        {
        	UseCaseEditorUtil.addLineBellow(tv, sf);             	
        }
    }
