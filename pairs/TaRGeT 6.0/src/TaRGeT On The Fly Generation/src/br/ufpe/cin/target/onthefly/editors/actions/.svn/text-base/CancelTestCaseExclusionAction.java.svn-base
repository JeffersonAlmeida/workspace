...
public class CancelTestCaseExclusionAction extends AbstractTCGAction
{
    ...
    {
        super(id, Properties.getProperty("cancel_test_case_exclusion"),
                Properties.getProperty("removes_the_selected_test_cases_from_the_exclusion_list"), selectionProvider);
