...
public abstract class HTMLGenerator
{
     ...
     */
    protected boolean hasFromOrToStepError(StepId stepId, List<Error> errors)
    {
     ...
     */
    protected boolean hasDuplicatedStepIdError(StepId stepId, List<Error> errors)
    {
        boolean result = false;
        for (Error error : errors)
        {
     ...
     * <code>stepId</code> or <code>false</code> otherwise.
     */
    protected boolean hasEmptyUseCaseFieldError(StepId stepId, List<Error> errors, String field,
